#!/bin/bash
# deploy-frontend-updated.sh - Deploy ONLY the frontend to Railway
...
# Create a new service for the frontend (updated syntax)
echo "Creating new Railway service for frontend..."
railway service new tiptap-frontend

# Switch to frontend service
echo "Switching to frontend service..."
railway link --service tiptap-frontend
