...
const MOCK_RESPONSES: Record<string, string[]> = {
  ...
  // Expand responses
  'expand': [
    'Building on the initial concept, we can explore multiple dimensions of this topic. First, consider the historical context that shaped its development. Originally conceived as a response to specific challenges, it has evolved through several distinct phases. Second, the theoretical framework encompasses complementary models. Third, practical implementations have demonstrated versatility across different contexts and use cases.',
    'We can elaborate on this subject by examining several key aspects. The foundational principles establish the conceptual boundaries and operative mechanisms. These principles have been refined through empirical testing and critique. The methodological approaches vary according to specific objectives and contextual factors. The practical applications span diverse domains.',
    'This topic has a multifaceted nature addressing fundamental questions about structure and function. The historical evolution shows how initial formulations have been continuously refined. Theoretical frameworks provide analytical tools for understanding complex interactions. Current research continues to expand the boundaries of what is possible.'
  ],
